namespace Contoso.Forms.Test
{
    public static class  TestStrings
    {
        ...
        /* Text values */
        public static readonly string IOExceptionMessage = "Server did not respond";
        public static readonly string DivideByZeroExceptionMessage = "Attempted to divide by zero.";
        public static readonly string AggregateExceptionMessage = "One or more errors occurred.";
        public static readonly string TestCrashExceptionName = "TestCrashException";
        public static readonly string TestCrashExceptionMessage = "Test crash exception generated by SDK";
        public static readonly string InvalidOperationExceptionMessage = "Sequence contains no matching element";
        ...
        public static readonly string DidSendingEventLabel = "DidSendingEventLabel";
        public static readonly string ResetPageButton = "ResetPageButton";

        /* Text values */
        public static readonly string DidSentEventText = "Sent event occurred";
        public static readonly string DidFailedToSendEventText = "Failed to send event occurred";
        public static readonly string DidSendingEventText = "Sending event occurred";
    }
}
