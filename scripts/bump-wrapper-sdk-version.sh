...
# appcenter-auth, appcenter-push, appcenter-data and appcenter-link-script NPM packages
...
# appcenter-auth, appcenter-push, appcenter-data and AppCenterReactNativeShared projects
for file in \
...
# appcenter-auth, appcenter-data, and appcenter-push
...
postlinkFileContent="$(cat ./appcenter-data/scripts/postlink.js)"
echo "${postlinkFileContent/$oldWrapperSdkVersion/$newWrapperSdkVersion}" > ./appcenter-data/scripts/postlink.js
