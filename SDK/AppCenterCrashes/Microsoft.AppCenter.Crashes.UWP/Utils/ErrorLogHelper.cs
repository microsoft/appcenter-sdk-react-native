...
namespace Microsoft.AppCenter.Crashes.Utils
{
    public partial class ErrorLogHelper
    {
        ...
        {
            // We don't support serializing exception for client side inspection on UWP, but we still need an empty file which acts as a marker for error report life cycle.
